...
export default function Backstory({ themeTextMuted }: BackstoryProps) {
  return (
    <section className="space-y-4 max-w-2xl">
      <span className="font-mono text-[10px] uppercase text-neutral-500 tracking-widest">// BACKGROUND_NOTE</span>
      ...
      <div className={`pt-4 grid grid-cols-1 md:grid-cols-2 gap-6 text-xs font-mono ${themeTextMuted} leading-relaxed`}>
        <p>
